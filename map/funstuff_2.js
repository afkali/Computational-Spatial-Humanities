var map = L.map('map',
    ...
    minZoom: 11, 
    maxBounds: [
      // bounces back so you cant see the rest of the map 
      //south west
      [53.226910, -5.754452],
      //north east
      [53.492040, -6.715756]
  ...
  .setView([53.3498, -6.2603], 11); // Dublin
...
var overlay = L.imageOverlay.rotated("dublin1883_XL.jpg", point1, point2, point3, {
  opacity: 1,
  interactive: true,
